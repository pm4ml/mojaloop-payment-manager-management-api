...
jest.mock('@internal/randomphrase', () => (() => 'random-id' ));
const randomPhrase = require('@internal/randomphrase');
const ControlServer = require('../../ControlServer');
const { getInternalEventEmitter, INTERNAL_EVENTS } = require('../../ControlServer/events');
const TestControlClient = require('./ControlClient');
